...
$l['nav_removesubscription'] = "Usuń subskrypcję";
...
$l['error_avatarurltoolong'] = "Nie można zmienić Twojego awatara, ponieważ podany adres URL nowego awatara jest za długi. Użyj krótszego adresu URL, który ma mniej niż 200 znaków.";
$l['error_avatartoobig'] = "Nie można zmienić Twojego awatara, ponieważ wskazany przez Ciebie awatar jest za duży. Maksymalne wymiary to {1} x {2} (szerokość x wysokość).";
...
$l['error_avatarimagemissing'] = "Brak awatara, wybierz plik przed próbą przesłania..";
...
$l['unsubscribe_from_forum'] = "Anuluj subskrypcję działu: {1}";
$l['unsubscribe_from_forum_desc'] = "Potwierdź anulowanie subskrybcji działu. Nie będziesz otrzymywać powiadomień o nowych wątkach w tym dziale i nie pojawi się ono na Twojej liście subskrybowanych działów.";
$l['unsubscribe_from_thread'] = "Anuluj subskrypcję wątku: {1}";
$l['unsubscribe_from_thread_desc'] = "Potwierdź anulowanie subskrybcji wątku.  Nie będziesz otrzymywać powiadomień o nowych odpowiedziach w wątku i nie pojawi się ono na Twojej liście subskrybowanych działów.";
$l['unsubscribe_change_notificaton'] = "Zmień metodę powiadamiania";
...
$l['do_unsubscribe_forum'] = "Anuluj subskrybcję działu";
$l['do_unsubscribe_thread'] = "Anuluj subskrybcję wątku";
...
$l['goto_first_unread'] = "Przejdź do pierwszego nieprzeczytanego postu";
