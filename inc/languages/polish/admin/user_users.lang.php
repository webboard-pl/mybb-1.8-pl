...
$l['search_for_user'] = "Znajdź użytkownika";
$l['browse_users'] = "Użytkownicy";
$l['browse_users_desc'] = "Przeglądaj listę użytkowników swojego forum - dowiedz się o nich więcej dzięki różnym trybom wyświetlania listy (widokom).";
$l['find_users'] = "Znajdź";
$l['find_users_desc'] = "Przeszukuj listę użytkowników swojego forum. Wypełniając więcej pól sprawisz, że kryteria wyszukiwania będą węższe, a wyniki bliższe oczekiwanym.";
$l['create_user'] = "Nowy użytkownik";
$l['create_user_desc'] = "Utwórz nowe konto użytkownika.";
$l['merge_users'] = "Połącz konta";
$l['merge_users_desc'] = "Połącz dwa różne konta użytkownika w jedno - \"Konto źródłowe\" zostanie wchłonięte przez \"Konto docelowe\". Posty, wątki, prywatne wiadomości, wydarzenia w kalendarzu, licznik postów oraz liczba znajomych konta źródłowego zostaną przekazane kontu docelowemu.<br /><span style=\"font-size: 15px;\">Pamiętaj, że tego procesu nie można cofnąć.</span>";
...
$l['inline_activated_more'] = "<small>{1} z zaznaczonych użytkowników aktywowało już swoje konto.</small>";
$l['inline_activated_failed'] = "Wszyscy zaznaczeni użytkownicy zostali aktywowani.";
$l['ban_time'] = "Znieś bana po<em>*</em>";
$l['ban_reason'] = "Powód";
...
$l['mass_prune_info'] = "Ta akcja zostanie zastosowana na {1} użytkownikach. Jeżeli będziesz kontynuować, opcja ta usunie wszystkie posty użytkownika starsze niż okres wybrany z listy poniżej.<br /><br /><strong>Miej na uwadze fakt, że jeżeli użytkownik napisał pierwszy post w wątku, cały wątek zostanie usunięty.</strong>";
...
$l['show_threads_last_day'] = "Pokazuj wątki z ostatniego dnia";
$l['show_threads_last_5_days'] = "Pokazuj wątki z ostatnich 5 dni";
$l['show_threads_last_10_days'] = "Pokazuj wątki z ostatnich 10 dni";
$l['show_threads_last_20_days'] = "Pokazuj wątki z ostatnich 20 dni";
$l['show_threads_last_50_days'] = "Pokazuj wątki z ostatnich 50 dni";
$l['show_threads_last_75_days'] = "Pokazuj wątki z ostatnich 75 dni";
$l['show_threads_last_100_days'] = "Pokazuj wątki z ostatnich 100 dni";
$l['show_threads_last_year'] = "Pokazuj wątki z ostatniego roku";
$l['show_all_threads'] = "Pokazuj wszystkie wątki";
...
$l['manage_views'] = "Zarządzaj widokami";
$l['none'] = "brak";
$l['search'] = "Znajdź";
