...
$l['user_titles_desc'] = "Zarządzaj tytułami użytkowników. Tytuły użytkowników są przyznawane na podstawie ilości postów użytkownika. Także tutaj możesz dodać własny obrazek gwiazdki, która będzie wyświetlana na podstawie liczby postów użytkownika.";
$l['add_new_user_title'] = "Nowy tytuł";
$l['add_new_user_title_desc'] = "Dodaj tytuły użytkowników. <i>Informacja: To <strong>nie jest</strong> <u><a href=\"index.php?module=user-group_promotions\">system awansów dla użytkowników.</a></u></i>";
