...
$l['recount_referrals'] = "Aktualizacja liczników poleconych użytkowników";
$l['recount_referrals_desc'] = "Po uruchomieniu: liczniki poleconych użytkowników w profilu zostaną przeliczone i uaktualnione do właściwych wartości.";
$l['recount_thread_ratings'] = "Aktualizacja ocen wątków";
$l['recount_thread_ratings_desc'] = "Po uruchomieniu: oceny wątków w działach zostaną przeliczone, a następnie zostaną uaktualnione do właściwych wartości.";
...
$l['success_rebuilt_poll_counters'] = "Liczniki głosów w ankietach zostały zaktualizowane.";
$l['success_rebuilt_user_post_counters'] = "Liczniki postów użytkowników zostały zaktualizowane.";
$l['success_rebuilt_user_thread_counters'] = "Liczniki wątków użytkowników zostały zaktualizowane.";
