...
$l['create_new_theme'] = "Nowy styl";
$l['create_new_theme_desc'] = "Utwórz nowy styl, bazujący na domyślnym. <strong>Paczki szablonów, arkusze CSS i inne ustawienia są kopiowane ze stylu głównego.</strong>";

$l['import_a_theme'] = "Importuj styl";
$l['import_a_theme_desc'] = "Zaimportuj styl z pliku znajdującego się na Twoim komputerze lub pod adresem URL.";
...
$l['browse_themes'] = "Przeglądaj style";
...
$l['browse_all_themes'] = "Przeglądaj wszystkie style";
...
$l['colors_manage'] = "Zarządzaj kolorami";
...
$l['colors_add'] = "Zarządzaj kolorami";
$l['colors_add_desc'] = "Lista kolorów dostępnych w tym stylu. Powinny być one zapisane w formacie \"kolor=nazwa\", na przykład <em>blue=Niebieski</em>. Każdy kolor powinien się znaleźć w nowej linii.";
...
$l['import_from_desc'] = "Wybierz plik, z którego zostanie zaimportowany nowy styl. Może to być plik znajdujący się na Twoim dysku lub pod podanym adresem URL. Pamiętaj, aby używać styli z <strong>zaufanych i sprawdzonych źródeł</strong>.";
...
$l['name'] = "Nazwa";
$l['name_desc'] = "Podaj nazwę dla nowego stylu.";
$l['display_order'] = "Kolejność";

$l['edit_theme_properties'] = "Edycja właściwości stylu";
$l['name_desc_edit'] = "Podaj nazwę dla tego stylu.";
...
$l['editor_theme'] = "Wygląd edytora";
$l['editor_theme_desc'] = "Wybierz wygląd edytora MyCode, który ma być używany w tym stylu. Wyglądy edytorów możesz znaleźć w katalogu <strong>jscripts/sceditor/themes</strong>.";
...
$l['table_spacing_desc'] = "Odstęp zawartości od brzegu komórek tabel, w pikselach. Jest to wartość atrybutu <em>cellpadding</em> w tagu <em>table</em>.";
$l['inner_border'] = "Cellspacing";
$l['inner_border_desc'] = "Odstęp pomiędzy komórkami tabel, w pikselach. Jest to wartość atrybutu <em>cellspacing</em> w tagu <em>table</em>.";
$l['save_theme_properties'] = "Zapisz właściwości stylu";
$l['save_stylesheet_order'] = "Zapisz kolejność arkuszy stylów";

$l['background'] = "Tło (background)";
...
$l['file_name_desc'] = "Nazwa arkusza, zwykle z rozszerzeniem <strong>.css</strong>";
...
$l['browse_results_for_mybb'] = "Przeglądaj wyniki dla MyBB {1}";
...
$l['error_missing_name'] = "Podaj nazwę stylu.";
...
$l['error_missing_stylesheet_name'] = "Podaj nazwę dla tego arkusza.";
...
$l['error_invalid_color'] = "Wybrany zestaw kolorów \"{1}\" zawiera nieprawidłowe znaki lub nie ma określonego formatu. W nazwie koloru i jego wartości dozwolone są tylko cyfry, litery Unicode i podkreślenia, które muszą być oddzielone znakiem „=”.";
