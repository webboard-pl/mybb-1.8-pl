...
$l['hello_desc'] = 'Przykładowy plugin, który pozwala na tworzenie wiadomości na stronie głównej i dodaje je do każdego posta.';
...
$l['hello_uninstall_message'] = 'Czy chcesz usunąć wszystkie wiadomości z bazy danych?';
