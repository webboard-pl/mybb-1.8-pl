...
$l['nav_resendactivation'] = "Ponowne wysyłanie e-maila aktywującego";
$l['nav_lostpw'] = "Przywracanie zapomnianego hasła";
...
$l['account_activation'] = "Aktywacja konta";
$l['activate_account'] = "Aktywuj konto";
$l['activation_code'] = "Kod aktywacji";

$l['email_user'] = "Pisanie e-maila do {1}";
$l['email_subject'] = "Temat";
$l['email_message'] = "Wiadomość";
$l['send_email'] = "E-mail";
$l['error_hideemail'] = "Odbiorca zdecydował się ukryć swój adres e-mail, więc nie możesz wysłać mu tą drogą wiadomości.";
$l['error_no_email_subject'] = "Musisz podać temat e-maila.";
$l['error_no_email_message'] = "Musisz podać treść e-maila.";

$l['login'] = "Zaloguj";
$l['pw_note'] = "Wielkość liter ma znaczenie!";
$l['lostpw_note'] = "Nie pamiętam hasła";
$l['lost_pw'] = "Zapomniane hasło";
$l['lost_pw_form'] = "Formularz przywracania hasła";
$l['email_address'] = "Adres e-mail:";
$l['request_user_pass'] = "Wyślij dane do logowania";
$l['profile'] = "Profil: {1}";
$l['registration_date'] = "Data rejestracji:";
$l['date_of_birth'] = "Data urodzenia:";
$l['birthdayhidden'] = "ukryto";
$l['birthday'] = "Urodziny:";
$l['local_time'] = "Czas lokalny:";
$l['local_time_format'] = "{1}, godzina {2}";
$l['users_forum_info'] = "Informacje o {1}";
$l['joined'] = "Dołączył:";
$l['lastvisit'] = "Ostatnia wizyta:";
$l['total_posts'] = "Razem postów:";
$l['ppd_percent_total'] = "{1} postów dziennie | {2} procent wszystkich postów";
$l['total_threads'] = "Razem wątków:";
$l['tpd_percent_total'] = "{1} wątków dziennie | {2} procent wszystkich wątków";
$l['find_posts'] = "Znajdź wszystkie posty";
...
$l['warn'] = "Ostrzeż";
$l['away_note'] = "{1} jest obecnie niedostępny.";
$l['away_reason'] = "Powód:";
$l['away_since'] = "Nie ma od:";
$l['away_returns'] = "Wraca:";
$l['away_no_reason'] = "Nie określono.";
...
$l['error_awaitingcoppa'] = "Nie możesz zalogować się na to konto, bo nie otrzymaliśmy jeszcze wypełnionego formularza COPPA od Twojego rodzica lub prawnego opiekuna.<br /><br />Twój rodzic lub prawny opiekun musi pobrać, wypełnić i wysłać nam kopię <a href=\"member.php?action=coppa_form\">formularza COPPA</a>.<br /><br />Gdy dotrze do nas wypełniony formularz, Twoje konto zostanie aktywowane.";
...
$l['lift_ban_in_mcp'] = "Zbanuj w sposób nietrwały tego użytkownika w panelu moderatora";
...
$l['redirect_registered'] = "Dziękujemy za rejestrację na {1}, {2}.<br />Teraz nastąpi przeniesienie na stronę główną forum.";
$l['redirect_registered_admin_activate'] = "Dziękujemy za rejestrację na {1}, {2}.<br />Twoje konto musi zostać aktywowane przez administratora. Przed aktywacją konta nie możesz pisać na forum.";
$l['redirect_loggedout'] = "Wylogowano z forum.<br />Teraz nastąpi przeniesienie na stronę główną forum.";
$l['redirect_alreadyloggedout'] = "Już wcześniej wylogowano z forum.<br />Teraz nastąpi przeniesienie na stronę główną forum.";
$l['redirect_lostpwsent'] = "Na Twój adres został wysłany e-mail z instrukcją dotyczącą resetowania hasła.<br /><br />Teraz nastąpi przeniesienie na stronę główną forum.";
...
$l['redirect_validated'] = "Twoje konto zostało aktywowane.<br />Teraz nastąpi przeniesienie na forum.";
