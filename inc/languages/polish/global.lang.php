...
$l['redirect_width'] = "50%";
$l['lastvisit_never'] = "Nigdy";
$l['lastvisit_hidden'] = "(ukryte)";

$l['search_button'] = "Szukaj";
$l['toplinks_memberlist'] = "Użytkownicy";
$l['toplinks_search'] = "Szukaj";
...
$l['welcome_modcp'] = "MCP";
$l['welcome_admin'] = "ACP";
$l['welcome_logout'] = "Wyloguj";
$l['welcome_login'] = "Logowanie";
$l['welcome_register'] = "Rejestracja";
$l['welcome_open_buddy_list'] = "Lista znajomych";
$l['welcome_newposts'] = "Pokaż nowe posty";
$l['welcome_todaysposts'] = "Pokaż dzisiejsze posty";
$l['welcome_pms'] = "Prywatne wiadomości";
$l['welcome_pms_usage'] = "({1} nowych, {2} wszystkich)";
$l['welcome_back'] = "<strong>Witaj, {1}</strong>. Ostatnia wizyta: {2}";
$l['welcome_guest'] = "Witaj!";
$l['welcome_current_time'] = "<strong>Aktualny czas:</strong> {1}";
...
$l['viewing_multiple'] = " ({1} przeglądających)";
$l['by'] = "przez";
...
$l['editor_inserttable'] = "Wstaw tabelę";
$l['editor_inserthr'] = "Wstaw poziomą linię";
$l['editor_code'] = "Kod";
...
$l['editor_currentdate'] = "Wstaw aktualną datę";
$l['editor_currenttime'] = "Wstaw aktualny godzinę";
...
$l['postbit_attachment_filename'] = "Nazwa pliku:";
...
$l['postbit_quote'] = "Odpowiedz cytując ten post";
...
$l['ratings_update_error'] = 'Wystąpił błąd podczas aktualizacji reputacji.';
...
$l['newpm_notice_one'] = "<strong>Masz jedną nieprzeczytaną prywatną wiadomość</strong> od {1}, zatytułowaną <a href=\"{2}/private.php?action=read&amp;pmid={3}\" style=\"font-weight: bold;\">{4}</a>";
$l['newpm_notice_multiple'] = "<strong>Liczba nowych nieprzeczytanych prywatnych wiadomości: {1}.</strong> Ostatnia z nich to wiadomość od {2}, zatytułowana <a href=\"{3}/private.php?action=read&amp;pmid={4}\" style=\"font-weight: bold;\">{5}</a>";
...
$l['debug_generated_in'] = "Wygenerowano w ciągu {1}";
