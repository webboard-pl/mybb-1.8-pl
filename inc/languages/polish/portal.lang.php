...
$l['latest_threads_lastpost'] = "Ostatni post:";
$l['private_messages'] = "Prywatne wiadomości";
$l['pms_received_new'] = "{1}, masz <b>{2}</b> nieprzeczytanych wiadomości.";
...
$l['welcome'] = "Witaj, {1}";
$l['guest_welcome_registration'] = "Musisz się <a href=\"{1}\">zarejestrować</a> przed napisaniem posta.";
...
$l['online_user'] = "Aktualnie jest <b>1</b> użytkownik online.";
