...
--";
$l['send_pm_options'] = "Opcje:";
$l['send_pm_options_anonymous'] = "<strong>Anonimowe PW</strong>: wyślij tę wiadomość jako użytkownik anonimowy.";
...
$l['redirect_warned_banned'] = "<br /><br />Użytkownik został też przeniesiony do grupy {1} na {2}.";
$l['redirect_warned_suspended'] = "<br /><br />Prawa tego użytkownika do pisania postów zostały zawieszone na {1}.";
$l['redirect_warned_moderate'] = "<br /><br />Wszystkie posty tego użytkownika będą musiały być zatwierdzane przez moderatorów przez {1}.";
